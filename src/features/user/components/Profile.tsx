...
export default function Profile({ userId, language = 'ar' }: ProfileProps) {
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        logger.error('Error fetching profile', { error: error instanceof Error ? error.message : 'Unknown error' });
      } finally {
        setIsLoading(false);
      }
    };
  ...
  useEffect(() => {
    const fetchFavorites = async () => {
      ...
      try {
        ...
        logger.error('Error fetching favorites', { error: error instanceof Error ? error.message : 'Unknown error' });
      } finally {
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logger.error('Error updating profile', { error: error instanceof Error ? error.message : 'Unknown error' });
  ...
  const removeFavorite = async (serviceId: string) => {
    ...
    try {
      ...
      logger.error('Error removing favorite', { error: error instanceof Error ? error.message : 'Unknown error' });
    }
  };
