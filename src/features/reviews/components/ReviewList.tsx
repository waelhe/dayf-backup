...
export function ReviewList({
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      ...
      try {
        ...
        logger.error('Error fetching reviews', { error: error instanceof Error ? error.message : 'Unknown error' });
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleHelpful = async (reviewId: string, isHelpful: boolean) => {
    ...
    try {
      ...
      logger.error('Error marking helpful', { error: error instanceof Error ? error.message : 'Unknown error' });
    }
  };
