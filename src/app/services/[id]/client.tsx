...
export default function ServiceDetailsClient() {
  ...
  const fetchService = async () => {
    try {
      ...
      logger.error('Error fetching service', { error: error instanceof Error ? error.message : 'Unknown error' });
  ...
  const handleBooking = async () => {
    ...
    try {
      ...
      logger.error('Error creating booking', { error: error instanceof Error ? error.message : 'Unknown error' });
