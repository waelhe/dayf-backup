...
export default function ProductDetailsClient({ productId }: ProductDetailsClientProps) {
  ...
  const fetchProduct = useCallback(async () => {
    ...
    try {
      ...
      logger.error('Error fetching product', { error: err instanceof Error ? err.message : 'Unknown error' });
  ...
  const addToCart = async () => {
    ...
    try {
      ...
      logger.error('Error adding to cart', { error: err instanceof Error ? err.message : 'Unknown error' });
