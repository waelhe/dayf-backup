...
export default function CommunityClient() {
  ...
  const fetchTopics = async () => {
    ...
    try {
      ...
      logger.error('Error fetching topics', { error: error instanceof Error ? error.message : 'Unknown error' });
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleCreateTopic = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logger.error('Error creating topic', { error: error instanceof Error ? error.message : 'Unknown error' });
  ...
  const handleLike = async (topicId: string) => {
    try {
      ...
      logger.error('Error liking topic', { error: error instanceof Error ? error.message : 'Unknown error' });
    }
  };
