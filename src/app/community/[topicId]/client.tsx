...
export default function TopicDetailsClient({ topicId }: TopicDetailsClientProps) {
  ...
  const fetchTopic = useCallback(async () => {
    ...
    try {
      ...
      logger.error('Error fetching topic', { error: err instanceof Error ? err.message : 'Unknown error' });
    ...
    try {
      ...
      if (response.ok) {
        ...
        setReplies(prev => [...prev, {
          ...
          content: replyContent,
          authorId: effectiveUserId,
          author: { id: effectiveUserId, displayName: 'مستخدم تجريبي' },
      ...
      logger.error('Error submitting reply', { error: err instanceof Error ? err.message : 'Unknown error' });
