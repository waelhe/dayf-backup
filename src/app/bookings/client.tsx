...
// حالياً نستخدم قيمة وهمية لأن API يتطلب userId صحيح
...
export default function BookingsClient() {
  ...
  const fetchBookings = useCallback(async () => {
    // إذا لم يسجل الدخول، لا نجلب الحجوزات
    if (!userId) {
      setLoading(false);
      setBookings([]);
      return;
    ...
    try {
      ...
      logger.error('Error fetching bookings', { error: err instanceof Error ? err.message : 'Unknown error' });
